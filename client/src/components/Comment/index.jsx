            ...
            >
              ...
              >
                ...
                {comment?.updatingComment ? (
                  ...
                  (comment?.file ? <div><Button href={`https://lv-diretus.hotanloc.xyz/assets/${comment.file}?download`} sx={{ width: 'fullwith', textTransform: 'none' }}><FilePresentIcon /> {comment?.directus_files?.title}</Button> </div> :
                    <Typography
                      variant="body2"
